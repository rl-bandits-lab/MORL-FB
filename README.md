...
```python3
python test.py --env_name mo-halfcheetah-v4 --model_name {time_str}_MORL-FB_{environment_name} --steps 3000000 --output_path rewards/MORL-FB/output.npy --cuda_device 0
```
